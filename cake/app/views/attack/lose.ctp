<table width="320" border="0">
  <tr>
    <td><div align="center"><a href="/cake/attack/top/<?php echo $member_quest_id; ?>">再挑戦する</a>/<a href="/cake/top/top/">トップに戻る</a> / <a href="/cake/quest/datalist/<?php echo $member_quest_id;?>">捜査に戻る</a></div></td>
  </tr>
</table>
...
function draw(){
  ...
  //images
  back_img = new Image();
  back_img.src =  "http://bank.blamestitch.com/img/movie/quest_fail/back.png?12";
  pika_img = new Image();
  pika_img.src =  "http://bank.blamestitch.com/img/movie/quest_fail/pika.png?142";
  human_img = new Image();
  human_img.src = "http://bank.blamestitch.com/img/movie/quest_fail/human.png?121";
  char_img = new Image();
  char_img.src =  "http://bank.blamestitch.com/img/movie/quest_fail/char.png?142";
